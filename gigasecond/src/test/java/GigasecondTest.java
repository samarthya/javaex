...
public class GigasecondTest {
    ...
    @Test
    public void timePresentTest() {
        Gigasecond gigaSecond = new Gigasecond(LocalDate.of(2020, Month.APRIL, 25));
        assertEquals(LocalDateTime.of(2052,01,02, 1, 46, 40), gigaSecond.getDateTime());
    }
